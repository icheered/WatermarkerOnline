...
<div
	class="flex flex-col items-center justify-center h-full border-2 border-gray-300 border-dashed rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600"
>
	{#if previewImageUrl && watermarkFile && files && files.length}
	...
	{:else}
		<div class="flex flex-col w-1/2 h-96 justify-center place-items-center">
			<div class="w-16">
				<FaRegImage />
			</div>
